...
<h1 style="text-align:center;color:white">Cart Contents</h1>
...
$sql = "SELECT si_no, Product, Quantity, Price FROM cartdata ORDER BY si_no ASC "; /*select items to display from the sensordata table in the data base*/
...
echo '<tr>
        ...
        <td colspan="2" id="totalprice">' . $total_price . '</td>
      </tr>';
...
<div class="butn">
<a onclick="myFunction()" href="razorpay-api"  class="btn btn-primary">Checkout</a>
</div>
<script>
function myFunction() {
